...
src/
  ...
  services/            # acceso a datos (supabase, trainings, profiles)
  stores/              # auth.store (sesión/rol), catalogs.store (áreas/sucursales)
  views/               # auth, dashboard, capacitación, checkin, admin, perfil
...
| [docs/03-flujos.md](docs/03-flujos.md) | Registro/login, QR, tracking de video |
...
- **Usuario** — ver capacitaciones, registrar asistencia con QR y su propio avance.
...
5. El admin ve en la ficha de la capacitación: asistentes, quiénes vieron el video, % de avance, tiempo visto y fecha de completado.
